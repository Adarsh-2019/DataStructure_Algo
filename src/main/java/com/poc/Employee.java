...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Map<String, List<Employee>>> product_development = employeeList.stream()
                .filter(emp -> emp.getAge() > 25 && emp.getAge() < 30)
                .filter(dept -> dept.getDepartment().equals("Product Development"))
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.groupingBy(Employee::getDepartment, Collectors.toList())));
